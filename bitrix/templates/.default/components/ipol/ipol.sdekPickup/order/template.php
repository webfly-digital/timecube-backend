...
<script>
    var IPOLSDEK_pvz = {
        ...
        init: function () {
            ...
            if (typeof BX !== 'undefined' && Boolean(BX.addCustomEvent)) {
        ...
        onLoad: function () {
            ...
            if (typeof BX.Sale.OrderAjaxComponent == 'object') {
                if (BX.Sale.OrderAjaxComponent.hasOwnProperty('orderData')) {
                    var ajaxAns = {};
                    ajaxAns = BX.Sale.OrderAjaxComponent.orderData;
                }
            }
        ...
        Y_turnSearch: function () {
            if (IPOLSDEK_pvz.Y_map) {
                if (!IPOLSDEK_pvz.Y_map.controls.get('searchControl')) {
                    IPOLSDEK_pvz.Y_map.controls.add('searchControl', {
                        float: 'right',
                        floatIndex: 100,
                        noPlacemark: true
                    });
