                ...
                <tr>
                    ...
                    <td class="basket-line-qty xs-hide sm-hide">
                        <div class="bxr-basket-group">
                            ...
                            <input type="button" class="bxr-quantity-button-plus" value="+" data-item="<?= $arBasketItem["ID"] ?>" data-ratio="<?= $arBasketItem["RATIO"] ?>" data-operation="auto_save"
                                   data-max="<?= $arBasketItem["QTY_MAX"] ?>" title="<?= GetMessage("SALE_QUANTITY_PLUS") ?>">
                        </div>
