<?
$MESS ['WF_VENDOR_NAME'] = "Настройки шаблона";
...
$MESS ['MARKET_CATEGORY_CHECK_TIP'] = 'Рекомендуется указывать для товара категорию в соответствии с документом <a href="https://support.google.com/merchants/answer/answer.py?answer=1705911">Google product taxonomy</a>.<br/><br/>Если не указано или у товара не заполнено свойство с категорией, в качестве категории будет выведена цепочка разделов инфоблока.';
?>