        ...
        <div class="product-card__pic product-card__row" data-entity="image-wrapper5">
            <a href="<?=$item['DETAIL_PAGE_URL']?>">
                <?if (!empty($item['HOVER_PHOTO'])) {?>
                    <img id="<?= $itemIds['PICT'] ?>" title="<?= $imgTitle ?>" class="lozad main" data-src="<?=$item['PREVIEW_PICTURE']['SRC']?>" src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="<?= $imgTitle ?>"/>
                    <img class="lozad hover" data-src="<?=$item['HOVER_PHOTO']?>" src="<?=$item['HOVER_PHOTO']?>" alt="<?= $imgTitle ?>"/>
                <?} else {?>
                    <img id="<?= $itemIds['PICT'] ?>" title="<?= $imgTitle ?>" class="lozad" data-src="<?= $item['PREVIEW_PICTURE']['SRC'] ?> " src="<?= $item['PREVIEW_PICTURE']['SRC'] ?>" alt="<?= $imgTitle ?>">
                <?}?>
            </a>
        </div>
    ...
    if (!empty($arParams['PRODUCT_BLOCKS_ORDER'])) {
        foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName) {
            switch ($blockName) {
                case 'price':
                    ?>
                    <? if ($showSubscribe & !$actualItem['CAN_BUY']): //1&1=1 ?>
                ...
                <?php else:?>
                    <div class="product-card__row product-card__row--centered" data-entity="price-block">
                        ...
                        echo ($price['RATIO_PRICE'] >= $price['RATIO_BASE_PRICE'] ? '':'product-card__prices--discount')
                ...
                case 'buttons':
                    ?>
                    <div class="product-card__buttons product-card__row product-card__row--centered" data-entity="buttons-block">
                        <?
                        if (!$haveOffers) {
                                    ...
                                    if ($showSubscribe) {
                                        $APPLICATION->IncludeComponent(
                                            ...
                                            array(
                                                ...
                                                'BUTTON_CLASS' =>   'btn btn-primary ' . $buttonSizeClass.'btn btn-sm btn-third btn-animated btn-cart bnt-cart-simple icon',
                            ...
                            if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y') {
                                ...
                                <div class="product-card__button-wrapper btn-animated-wrapper wide">
                                    ...
                                    ?>
                                    <button class="btn btn-sm btn-third btn-animated btn-cart bnt-cart-simple" rel="nofollow"
                                ...
                                ?>
                                <div class="product-card__button-wrapper btn-animated-wrapper">
                                    <a class="btn btn-sm btn-third btn-animated btn-cart bnt-cart-simple" title="<?= $arParams['MESS_BTN_DETAIL'] ?>"
                        ...
                        if (
                            ...
                            ?>
                            <div class="product-card__button-wrapper btn-animated-wrapper">
                                <button id="<?= $itemIds['COMPARE_LINK'] ?>" class="btn btn-sm btn-third btn-animated btn-compare" title="В сравнение"
