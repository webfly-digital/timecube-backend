                        ...
                        <div class="wf-popup wf-popup-medium wf-popup-nopadding" id="popup-3d">
                            <? if ($arResult['SHOW_3D']) { ?>
                                <div class="product-detail__3d-wrapper">
                                    <div id="the360block">
                                        <img src="<?= $arResult['PATH_3D'] . $arResult['COUNT_3D'] . '.jpg' ?>" alt=""
                                             id="the360image"
...
//                             $checkSale =  $USER->IsAdmin() ? true: false;
            ...
            ?>
            <meta itemprop="image" content="https://timecube.ru<?= $initalImageSrc ?>"/>
            <meta itemprop="name" content="<?= $name ?>"/>
            <meta itemprop="description" content="<?
            echo $arResult['IPROPERTY_VALUES']['ELEMENT_META_DESCRIPTION'] ? $arResult['IPROPERTY_VALUES']['ELEMENT_META_DESCRIPTION'] : $arResult['PREVIEW_TEXT']
            ?>"/>
            <meta itemprop="category" content="<?= $arResult['CATEGORY_PATH'] ?>"/>
            <meta itemprop="model" content="<?= $arResult['PROPERTIES']['CML2_ARTICLE']['VALUE'] ?>"/>
            <meta itemprop="brand" content="<?= $arResult["MANUFACTUR"]['NAME'] ?>"/>
            <? if ($haveOffers) {
...
<? if (!empty($arResult['PROPERTIES']["VIDEO"]['VALUE'])) {
    ...
    <div itemscope itemprop="VideoObject" itemtype="https://schema.org/VideoObject">
        <meta itemprop="name" content="<?= $name ?>">
        <meta itemprop="uploadDate" content="<?= $newDate ?>">
        <meta itemprop="description" content="<?= strip_tags($arResult['DETAIL_TEXT']) ?>">
        <meta itemprop="embedUrl" content="https://<?= SITE_SERVER_NAME . $arResult['DETAIL_PAGE_URL'] ?>">
        <meta itemprop="contentUrl" content="<?= $videoUrl ?>">
        <meta itemprop="thumbnailUrl" content="https://<?= SITE_SERVER_NAME . $initalImageSrc ?>">
    </div>
            ...
            <aside class="col-12 col-md-3">
                <div class="product-detail__brand">
                    <img class="lozad" loading="lazy" data-src="<?= $arResult["MANUFACTUR"]['IMAGE_SRC'] ?>"
                         alt="<?= $arResult["MANUFACTUR"]['NAME'] ?>" src="<?= $arResult["MANUFACTUR"]['IMAGE_SRC'] ?>">
                </div>
            </aside>
        </div>
    </section>
...
<? } ?>
<? $weight = 1;//$arResult['PROPERTIES']["XXX_PACK_GROSS_KG"]['VALUE'] ? $arResult['PROPERTIES']["XXX_PACK_GROSS_KG"]['VALUE'] : 2;    ?>
    <section class="py-4" id="anchorSdek">
        ...
        <div class="row justify-content-between">
            <div class="col-12 col-md-9 col-xl-8">
                <div>Для расчёта стоимости и сроков доставки <b>введите ваш город в строке поиска.</b> Многие товары из нашего каталога доставляются бесплатно. Ищите предложения со стикерами &quot;Бесплатно по России&quot; и &quot;Бесплатно по Москве и Санкт-Петербургу.&quot;</div>
                <div id="showSdek" data-weight=<?= $weight ?>>
