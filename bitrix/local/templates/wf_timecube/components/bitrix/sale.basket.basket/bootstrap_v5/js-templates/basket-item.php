...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		...
		{{^SHOW_RESTORE}}
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						?>
						<h4 class="basket-item-info-name">
							{{#DETAIL_PAGE_URL}}
                        ...
                        {{#SHOW_PACK_BTN}}
                        <p class="basket-item-select-pack">
                            <span class="svg-icon icon-giftcard-alt"></span>
                            <a class="select-pack link-green"
                               data-productid="{{PRODUCT_ID}}" data-basketid="{{ID}}"
                               data-freepack="{{FREE_PACK}}"
                            >{{PACK_BTN_TITLE}}</a>
                        </p>
                        {{/SHOW_PACK_BTN}}
					</div>
			...
			?>
			<td class="basket-items-list-item-amount" {{#NO_CONTROLS}}style="pointer-events: none;"{{/NO_CONTROLS}}>
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
					data-entity="basket-item-quantity-block">

					<span class="btn btn-xs basket-item-amount-btn-minus" data-entity="basket-item-quantity-minus"></span>
					<div class="basket-item-amount-filed-block">
						<input type="text" class="input-sm basket-item-amount-filed" value="{{QUANTITY}}"
							{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
							data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
							id="basket-item-quantity-{{ID}}">
					</div>
					<span class="btn btn-xs basket-item-amount-btn-plus" data-entity="basket-item-quantity-plus"></span>
