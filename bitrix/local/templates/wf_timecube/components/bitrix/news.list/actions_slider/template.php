                ...
                <div class="action-item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>" >
                    <a href="<?=$arItem['DETAIL_PAGE_URL']?>">
                        <div class="action-item__pic action-item__pic--desktop">
                            <img <?/*loading="lazy" alt="<?=$arItem['NAME']?>" class="lozad" data-src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>"*/?>
                                  src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>">
                        </div>
                        <div class="action-item__pic action-item__pic--mobile">
                            <img <?/*loading="lazy" class="lozad"  data-src="<?=$arItem['DETAIL_PICTURE']['SRC']?>"*/?> alt="<?=$arItem['NAME']?>!"
