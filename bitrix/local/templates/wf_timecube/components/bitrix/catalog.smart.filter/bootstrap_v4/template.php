        ...
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            <div class="smart-filter-input-group-checkbox-list">
                <div class="form-group form-check mb-1">
                    <input type="checkbox" name="available" id="products_available" class="form-check-input"
                           value="" <?= $available == 'y' ? 'checked' : '' ?>/>
                    <label class="smart-filter-checkbox-text form-check-label" data-role="label_products_available"
                           for="products_available">Товары в наличии</label>
                </div>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<? else: ?>col-12<? endif ?> mb-2 smart-filter-parameters-box bx-active">
                            ...
                            <div class="smart-filter-block" data-role="bx_filter_block">
                                <div class="smart-filter-parameters-box-container">
                                    <div class="smart-filter-block-range">
                                        <div class="inputs">
                                            <input step="100"
                                        ...
                                        <div class="range-wrapper">
                                            <div class="filter-range" id="drag_track_<?= $key ?>">
                                                <?/*for($i = 0; $i <= $step_num; $i++):?>
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<? else: ?>col-lg-12<? endif ?> mb-2 smart-filter-parameters-box <? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>bx-active<? endif ?>">
                        ...
                        <div class="smart-filter-parameters-box-title <? if ($arItem["FILTER_HINT"] <> ""): ?>hint-inside<? endif ?>"
                             onclick="smartFilter.hideFilterProps(this)">
                            <?= $arItem["NAME"] ?>

                            <? if ($arItem["FILTER_HINT"] <> ""): ?>
                                <span class="smart-filter-hint">
									<span class="smart-filter-hint-icon svg-icon icon-support"></span>
									<span class="smart-filter-hint-popup"><?= $arItem["FILTER_HINT"] ?></span>
								</span>
                            <? endif ?>
                            ...
                            <div class="smart-filter-parameters-box-container">
                                ...
                                case "A":
                                    ...
                                    <div class="smart-filter-input-group-number ">
                                        <div class="d-flex justify-content-between smart-filter-input-group-number_custom_wf">

                                            <div class="form-group">
                                                <div class="smart-filter-input-container">
                                                    <input
                                                            class="min-price form-control form-control-sm input-sm"
                                                            type="number"
                                                            step="1"
                                                            name="<? echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"] ?>"
                                                            id="<? echo $arItem["VALUES"]["MIN"]["CONTROL_ID"] ?>"
                                            ...
                                            <div class="form-group">
                                                <div class="smart-filter-input-container">
                                                    <input
                                                            class="max-price form-control form-control-sm input-sm"
                                                            type="number"
                                                            step="1"
                                                            name="<? echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"] ?>"
                                                            id="<? echo $arItem["VALUES"]["MAX"]["CONTROL_ID"] ?>"
                                        ...
                                        <div class="smart-filter-slider-track-container">
                                            <div class="smart-filter-slider-track" id="drag_track_<?= $key ?>">
                                                ...
                                                <div class="smart-filter-slider-range" id="drag_tracker_<?= $key ?>">
                                                    <a class="smart-filter-slider-handle left" href="javascript:void(0)"
                ...
                <div class="col smart-filter-button-box">
                    ...
                    <div class="smart-filter-popup-result <? if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"] ?>"
                        ...
                        <a href="<? echo $arResult["FILTER_URL"] ?>"
                           target="_self"><? echo GetMessage("CT_BCSF_FILTER_SHOW") ?></a>
                    </div>
                </div>
            </div>
        </form>
