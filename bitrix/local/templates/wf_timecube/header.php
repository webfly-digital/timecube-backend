...
<head>
    ...
    <meta name="yandex-verification" content="20a65e0abfe2c34d"/>
    ...
    <aside class="sidebar <?= $sidebarView ?>" id="sidebar">
        <div class="sidebar-top <?= $isMainPage ? 'd-none d-xl-block' : '' ?>" id="sidebar-top">
            <div class="container-fluid">
                <a class="logo" href="/" title="Timecube.ru"><img src="/assets/img/logo-timecube.svg" alt="Timecube.ru"></a>
            </div>
        </div>
        ...
        <header class="header">
            ...
            <div class="container-fluid">
                ...
                <div class="header__bottom">
                    <div class="header__bottom-section header-logo"><a class="logo" href="/" title="Timecube.ru"><img height="33" width="200"
