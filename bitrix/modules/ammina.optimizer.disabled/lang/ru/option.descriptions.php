...
// Option group: main -> request -> ACTIVE_COMPONENT_CACHE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_REQUEST_ACTIVE_COMPONENT_CACHE_TITLE'] = 'Обработка шаблонов компонентов';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_REQUEST_ACTIVE_COMPONENT_CACHE_DESCRIPTION'] = 'Обработка шаблонов компонентов (предоптимизация))';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_REQUEST_ACTIVE_COMPONENT_CACHE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_REQUEST_ACTIVE_COMPONENT_CACHE_SHORT_Y'] = 'Шаблоны компонентов';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_REQUEST_ACTIVE_COMPONENT_CACHE_SHORT_N'] = '';
...
// Group: main -> delay
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TITLE'] = 'Отложенная загрузка';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DESCRIPTION'] = 'Настройки отложенной загрузки скриптов, стилей';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_HELP'] = '';

// Option group: main -> delay -> ACTIVE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_ACTIVE_TITLE'] = 'Разрешить отложенную загрузку скриптов и стилей';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_ACTIVE_DESCRIPTION'] = 'При включении функции загрузка некоторых скриптов и стилей будет выполняться с задержкой';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_ACTIVE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_ACTIVE_SHORT_Y'] = 'Активно';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_ACTIVE_SHORT_N'] = 'Не активно';

// Option group: main -> delay -> TIME
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_TITLE'] = 'Отложить подключение на время, мс';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_DESCRIPTION'] = 'Время откладывания подключения выбранных опций';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_SHORT'] = '';

// Option group: main -> delay -> TIME_BETWEEN_EXECUTE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_BETWEEN_EXECUTE_TITLE'] = 'Время между запусками отложенных скриптов, мс';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_BETWEEN_EXECUTE_DESCRIPTION'] = 'Время между одним и следующим подключением/запуском отложенного скрипта или стиля';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_BETWEEN_EXECUTE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_TIME_BETWEEN_EXECUTE_SHORT'] = '';

// Option group: main -> delay -> DELAY_YMETRIKA
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YMETRIKA_TITLE'] = 'Яндекс метрика';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YMETRIKA_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YMETRIKA_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YMETRIKA_SHORT_Y'] = 'Яндекс метрика';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YMETRIKA_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_GTM
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GTM_TITLE'] = 'GoogleTagManager';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GTM_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GTM_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GTM_SHORT_Y'] = 'GoogleTagManager';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GTM_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_GANALYTICS
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GANALYTICS_TITLE'] = 'Google аналитика';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GANALYTICS_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GANALYTICS_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GANALYTICS_SHORT_Y'] = 'Google аналитика';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GANALYTICS_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_GRECAPTCHA
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GRECAPTCHA_TITLE'] = 'Google рекапча';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GRECAPTCHA_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GRECAPTCHA_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GRECAPTCHA_SHORT_Y'] = 'Google рекапча';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_GRECAPTCHA_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_ROISTAT
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_ROISTAT_TITLE'] = 'Roistat.com';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_ROISTAT_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_ROISTAT_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_ROISTAT_SHORT_Y'] = 'Roistat.com';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_ROISTAT_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_BITRIXINFO
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXINFO_TITLE'] = 'Bitrix.info';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXINFO_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXINFO_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXINFO_SHORT_Y'] = 'Bitrix.info - скрипт скорости сайта';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXINFO_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_BITRIXSPREAD
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXSPREAD_TITLE'] = 'Bitrix spread';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXSPREAD_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXSPREAD_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXSPREAD_SHORT_Y'] = 'Bitrix spread - скрипт распространения cookies по доменам';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIXSPREAD_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_BITRIX24
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIX24_TITLE'] = 'Bitrix24';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIX24_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIX24_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIX24_SHORT_Y'] = 'Bitrix24 - виджеты bitrix24 и корпоративного портала';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_BITRIX24_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_JIVOSITE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_JIVOSITE_TITLE'] = 'JivoSite';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_JIVOSITE_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_JIVOSITE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_JIVOSITE_SHORT_Y'] = 'JivoSite - виджет онлайн-чата';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_JIVOSITE_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_REGMARKETS
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REGMARKETS_TITLE'] = 'Regmarkets.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REGMARKETS_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REGMARKETS_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REGMARKETS_SHORT_Y'] = 'Regmarkets.ru - скрипты сервиса';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REGMARKETS_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_LIVETEX
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_LIVETEX_TITLE'] = 'LiveTex.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_LIVETEX_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_LIVETEX_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_LIVETEX_SHORT_Y'] = 'LiveTex.ru - онлайн чат';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_LIVETEX_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_TALKME
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_TALKME_TITLE'] = 'Talk-Me.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_TALKME_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_TALKME_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_TALKME_SHORT_Y'] = 'Talk-Me.ru - онлайн чат';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_TALKME_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_YACHAT
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YACHAT_TITLE'] = 'Yandex chat';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YACHAT_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YACHAT_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YACHAT_SHORT_Y'] = 'Yandex chat - онлайн чат';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YACHAT_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_REDHELPER
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REDHELPER_TITLE'] = 'RedHelper.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REDHELPER_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REDHELPER_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REDHELPER_SHORT_Y'] = 'RedHelper.ru - онлайн чат';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_REDHELPER_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_SENDPULSE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_SENDPULSE_TITLE'] = 'SendPulse.com';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_SENDPULSE_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_SENDPULSE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_SENDPULSE_SHORT_Y'] = 'SendPulse.com - скрипты сервиса';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_SENDPULSE_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_MAILRU
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_MAILRU_TITLE'] = 'Mail.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_MAILRU_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_MAILRU_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_MAILRU_SHORT_Y'] = 'Mail.ru рейтинг';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_MAILRU_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_RAMBLERRU
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_RAMBLERRU_TITLE'] = 'Rambler.ru';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_RAMBLERRU_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_RAMBLERRU_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_RAMBLERRU_SHORT_Y'] = 'Rambler.ru - ТОП 100';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_RAMBLERRU_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_YANDEXMAPS
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YANDEXMAPS_TITLE'] = 'Яндекс карты';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YANDEXMAPS_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YANDEXMAPS_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YANDEXMAPS_SHORT_Y'] = 'Скрипты Яндекс карт';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_YANDEXMAPS_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_FACEBOOK
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_FACEBOOK_TITLE'] = 'Facebook.com';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_FACEBOOK_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_FACEBOOK_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_FACEBOOK_SHORT_Y'] = 'Facebook.com - скрипты';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_FACEBOOK_SHORT_N'] = '';

// Option group: main -> delay -> DELAY_VK
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_VK_TITLE'] = 'VK.com';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_VK_DESCRIPTION'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_VK_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_VK_SHORT_Y'] = 'VK.com - OpenAPI';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_DELAY_VK_SHORT_N'] = '';

// Option group: main -> delay -> OTHER_URL_EXCLUDE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_EXCLUDE_TITLE'] = 'Исключить URL из отложенной загрузки';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_EXCLUDE_DESCRIPTION'] = 'Скрипты, которые соответствуют указанным URL, будут исключены из отложенной загрузки';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_EXCLUDE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_EXCLUDE_SHORT'] = '';

// Option group: main -> delay -> OTHER_URL_INCLUDE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_INCLUDE_TITLE'] = 'Включить URL в отложенную загрузку';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_INCLUDE_DESCRIPTION'] = 'Скрипты, которые соответствуют указанным URL, будут включены в отложенную загрузку';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_INCLUDE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_URL_INCLUDE_SHORT'] = '';

// Option group: main -> delay -> OTHER_JSCONTENT_EXCLUDE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_EXCLUDE_TITLE'] = 'Исключить контент из отложенной загрузки';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_EXCLUDE_DESCRIPTION'] = 'Скрипты, содержимое которых соответствуют указанным правилам, будут исключены из отложенной загрузки';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_EXCLUDE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_EXCLUDE_SHORT'] = '';

// Option group: main -> delay -> OTHER_JSCONTENT_INCLUDE
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_INCLUDE_TITLE'] = 'Включить контент в отложенную загрузку';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_INCLUDE_DESCRIPTION'] = 'Скрипты, содержимое которых соответствуют указанным URL, будут включены в отложенную загрузку';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_INCLUDE_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_MAIN_GROUP_DELAY_OTHER_JSCONTENT_INCLUDE_SHORT'] = '';
...
// Option group: js -> ext -> CHECK_ENCODING
$MESS['AMOPT_OPTION_GROUP_JS_GROUP_EXT_CHECK_ENCODING_TITLE'] = 'Конвертировать файлы перед минификацией в UTF-8 и обратно после минификации';
$MESS['AMOPT_OPTION_GROUP_JS_GROUP_EXT_CHECK_ENCODING_DESCRIPTION'] = 'Функция предназначена для сайтов в кодировке Windows-1251 при использовании русских символов в JavaScript файлах. Для работы функции необходима библиотека PHP MBString';
$MESS['AMOPT_OPTION_GROUP_JS_GROUP_EXT_CHECK_ENCODING_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_JS_GROUP_EXT_CHECK_ENCODING_SHORT_Y'] = '';
$MESS['AMOPT_OPTION_GROUP_JS_GROUP_EXT_CHECK_ENCODING_SHORT_N'] = '';
...
// Option group: images -> lazy -> CONVERT_WEBP
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_LAZY_CONVERT_WEBP_TITLE'] = 'Конвертировать в WebP';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_LAZY_CONVERT_WEBP_DESCRIPTION'] = 'Конвертировать файл-заглушку в WebP формат';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_LAZY_CONVERT_WEBP_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_LAZY_CONVERT_WEBP_SHORT_Y'] = '';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_LAZY_CONVERT_WEBP_SHORT_N'] = '';
...
// Option group: images -> other -> PRELOAD_IMG
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_TITLE'] = 'Предзагрузка изображений Inline';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_DESCRIPTION'] = 'Активирует предзагрузку изображений страницы';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_SHORT_Y'] = 'Предзагрузка изображений';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_SHORT_N'] = '';

// Option group: images -> other -> PRELOAD_IMG_COUNT
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_COUNT_TITLE'] = 'Количество изображений для предзагрузки';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_COUNT_DESCRIPTION'] = 'Максимальное количество изображений для предзагрузки (0 - без ограничений)';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_COUNT_HELP'] = '';
$MESS['AMOPT_OPTION_GROUP_IMAGES_GROUP_OTHER_PRELOAD_IMG_COUNT_SHORT'] = '';
