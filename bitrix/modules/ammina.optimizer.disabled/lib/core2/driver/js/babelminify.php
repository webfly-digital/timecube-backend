...
class BabelMinify extends Base
{
	public function optimizeJs($strOriginalFilePath, $strResultFilePath, $strTmpResultFilePath, $strResultInfoFilePath, $arOptions = array(), $bDoubleConvertEncoding = false)
	{
		...
		$strCommand = \COption::GetOptionString("ammina.optimizer", "lib_path_babelminify", "babel-minify") . " \"" . $_SERVER['DOCUMENT_ROOT'] . $strResultFilePathEncoded . "\" --mangle -o \"" . $_SERVER['DOCUMENT_ROOT'] . $strTmpResultFilePath . "\"";
		@exec($strCommand);
