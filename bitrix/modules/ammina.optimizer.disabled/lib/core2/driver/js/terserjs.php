...
class TerserJs extends Base
{
	public function optimizeJs($strOriginalFilePath, $strResultFilePath, $strTmpResultFilePath, $strResultInfoFilePath, $arOptions = array(), $bDoubleConvertEncoding = false)
	{
		...
		$strCommand = \COption::GetOptionString("ammina.optimizer", "lib_path_terserjs", "terserjs") . " -m -o \"" . $_SERVER['DOCUMENT_ROOT'] . $strTmpResultFilePath . "\" \"" . $_SERVER['DOCUMENT_ROOT'] . $strResultFilePathEncoded . "\"";
		@exec($strCommand);
