...
class UglifyJs2 extends Base
{
	public function optimizeJs($strOriginalFilePath, $strResultFilePath, $strTmpResultFilePath, $strResultInfoFilePath, $arOptions = array(), $bDoubleConvertEncoding = false)
	{
		...
		$strCommand = \COption::GetOptionString("ammina.optimizer", "lib_path_uglifyjs2", "uglifyjs2") . " -m -o \"" . $_SERVER['DOCUMENT_ROOT'] . $strTmpResultFilePath . "\" \"" . $_SERVER['DOCUMENT_ROOT'] . $strResultFilePathEncoded . "\"";
		@exec($strCommand);
