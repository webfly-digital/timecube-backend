			...
			<div class="main-user-consent-request-popup-body">
				...
				<div data-bx-content="" class="main-user-consent-request-popup-content">
					...
					<div class="main-user-consent-request-popup-buttons">
						<span data-bx-btn-accept="" class="btn btn-sm btn-primary main-user-consent-request-popup-button main-user-consent-request-popup-button-acc">Y</span>
						<span data-bx-btn-reject="" class="btn btn-sm  btn-third main-user-consent-request-popup-button main-user-consent-request-popup-button-rej">N</span>
					</div>
				</div>
			</div>
		</div>
