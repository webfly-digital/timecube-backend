...
<noindex>
    <h3 class="bx-title"><?=$APPLICATION->ShowTitle()?></h3>
<?
...
<?elseif(!$arResult["SHOW_EMAIL_SENT_CONFIRMATION"]):?>
	...
	<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data">
		...
		<input type="hidden" name="wf_check" value="" id="wf_check"/>
		...
		<div class="bx-authform-formgroup-container" style="display: none">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_LOGIN" maxlength="255" value="as_email<?//=$arResult["USER_LOGIN"]?>" />
			</div>
		</div>
...
document.getElementById('wf_check').value = '<?
    // look local/php_interface/init.php
    echo md5('wf_check_secret_1687184'.bitrix_sessid());
    ?>';
</script>
