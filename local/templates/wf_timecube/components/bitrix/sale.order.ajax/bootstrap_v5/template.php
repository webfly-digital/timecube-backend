...
if (strlen($request->get('ORDER_ID')) > 0) {
        ...
        <div id="bx-soa-order" class="row" style="opacity: 0">
            ...
            <div class="col-lg-8 col-md-7 bx-soa">
                ...
                <?php if ($arParams['BASKET_POSITION'] === 'before'): ?>
                    <!--	BASKET ITEMS BLOCK	-->
                    <div id="bx-soa-basket" data-visited="false" class="bx-soa-section collapse-section bx-active">
                        <div class="bx-soa-section-title-container collapse-mode d-flex justify-content-between align-items-center flex-nowrap">
                            <div class="bx-soa-section-title" data-entity="section-title-">
                                <span class="bx-soa-section-title-count"></span>
                                <?= $arParams['MESS_BASKET_BLOCK_NAME'] ?>
                            </div>
                            <div>
                                <a href="#" class="collapse-section__link">
                                    <span class="caption caption-show"><?= Loc::getMessage('COLLAPSE_SHOW_DEFAULT') ?></span>
                                    <span class="caption caption-hide"><?= Loc::getMessage('COLLAPSE_HIDE_DEFAULT') ?></span>
                                </a>
                            </div>
                        </div>
                        <div id="bx-soa-basket-content" class="bx-soa-section-content"></div>
                    </div>
                <?php endif ?>
                ...
                <div id="bx-soa-orderSave">
                    ...
                    <p class="text-center">
                        <a href="javascript:void(0)" style="margin: 10px 0"
                           class="btn btn-primary btn-lg d-none d-sm-inline-flex" data-save-button="true">
                            <?= $arParams['MESS_ORDER'] ?>
                        </a>
                    </p>
    ...
    <script>
        ...
        BX.saleOrderAjax.init(<?=CUtil::PhpToJSObject(array(
            'sourceLocation' => $templateFolder . '/get-location.php',
