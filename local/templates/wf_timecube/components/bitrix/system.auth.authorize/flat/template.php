...
<?endif?>
	...
	<p class="h3 bx-title"><?=GetMessage("AUTH_PLEASE_AUTH")?></p>
...
<?endif?>
	...
	<form name="form_auth" method="post" target="_top" action="<?=$APPLICATION->getCurDir()//login/?>?login=yes">

		<input type="hidden" name="AUTH_FORM" value="Y" />
		<input type="hidden" name="TYPE" value="AUTH" />
<?if (strlen($arResult["BACKURL"]) > 0):?>
		<input type="hidden" rel="nofollow" name="backurl" value="<?=$arResult["BACKURL"]?>" />
<?endif?>
