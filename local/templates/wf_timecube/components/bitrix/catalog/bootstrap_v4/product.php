...
//                'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
                ...
                'STRICT_SECTION_CHECK' => "N",//(isset($arParams['DETAIL_STRICT_SECTION_CHECK']) ? $arParams['DETAIL_STRICT_SECTION_CHECK'] : ''),
            ...
            if ($elementId > 0) {
                ...
                if ($obCache->InitCache(36000, serialize($recommendedCacheId), '/catalog/recommended')) {
                    ...
                    if (Loader::includeModule('catalog')) {
                        ...
                        $recommendedData['IBLOCK_LINK'] = 'ATTACHED';
                ...
                if (!empty($recommendedData)) {
                        ...
                        <section class="py-4" data-entity="parent-container">
                            <div class="heading" data-entity="header" style="display: none">
                                <div class="heading__item">
                                    <p class="heading__title">Другие модификации</p>
                                </div>
                                <div class="heading__item"><a class="heading__link"></a></div>
                            </div>
                            <?
                            $APPLICATION->IncludeComponent('bitrix:catalog.recommended.products', 'bootstrap_v4',
                                array(
                                    'ID' => $elementId,
                                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                    ...
                    if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N') {
                        ...
                        <section class="py-4" data-entity="parent-container">
                            <div class="heading" data-entity="header" style="display: none">
                                <div class="heading__item">
                                    <p class="heading__title">Популярные</p>
                                </div>
                                <div class="heading__item"><a class="heading__link"></a></div>
                            </div>
                            <? $APPLICATION->IncludeComponent('bitrix:catalog.section', 'slider-simple',
                                array(
                                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
//                                    'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
//                                    'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
                    ...
                    if (
                        ...
                        <section class="py-4" data-entity="parent-container">
                            <div class="heading" data-entity="header" style="display: none">
                                <div class="heading__item">
                                    <p class="heading__title">Вы смотрели</p>
                                </div>
                                <div class="heading__item"><a class="heading__link"></a></div>
                            </div>
                            <? $APPLICATION->IncludeComponent('bitrix:catalog.products.viewed', 'bootstrap_v4',
                                array(
                                    'IBLOCK_MODE' => 'single',
                                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
    ...
    <aside class="three-columns__sidebar bg-white">
        <? $APPLICATION->ShowViewContent("detail_aside") ?>
    </aside>
</div>
